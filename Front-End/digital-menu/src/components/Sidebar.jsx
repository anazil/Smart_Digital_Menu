    ...
    <aside className={`sidebar ${sidebarCollapsed ? 'collapsed' : ''}`}>
      <div className="sidebar-header">
        <div className="brand">
          ...
          {!sidebarCollapsed && (
            <span className="brand-text">CliqEat</span>
          )}
        </div>
        <button 
        ...
        >
          <Icon name={sidebarCollapsed ? 'arrow-right' : 'arrow-left'} className="w-4 h-4" />
        </button>
      </div>
      ...
      <nav className="sidebar-nav">
        {navigationItems.map((item) => (
          ...
          >
            <Icon name={item.icon} className="nav-icon w-5 h-5" />
            {!sidebarCollapsed && (
      ...
      <div className="sidebar-footer">
        ...
        >
          <Icon name="arrow-right-on-rectangle" className="nav-icon w-5 h-5" />
